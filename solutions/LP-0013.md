...
- **Commit:** [`a745528d`](https://github.com/ego-errante/logos-execution-zone/commit/a745528d)
- **Key files:**
  ...
  - `artifacts/token.idl.spel.json` — SPEL-emitted IDL (provenance, generated from `spel-spike/`)
  - `artifacts/token.idl.json` — hand-authored canonical IDL (completeness, conforms to `SpelIdl`)
  - `spel-spike/` — sidecar Cargo package outside the workspace that hosts the SPEL-shape mirror
...
- **Sidecar scaffold:** [`spel-spike/`](https://github.com/ego-errante/logos-execution-zone/tree/lp-0013-token-authorities/spel-spike)
