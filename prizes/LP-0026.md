...
- The forum must be functional, and usable by a non-expert: coherent navigation across topics, browsing messages, and clear error/pending states. This is judged against overall impression rather than a checklist: evaluators will use the forum as an ordinary user would.
