...
**Functionality**
- Applications must not depend on any centralised server or service.
- Use the Logos stack, eg: **Logos Storage** (storage/data availability), **Logos Delivery** (messaging) for publishing data, **Logos Chat** (messaging) for end-to-end encrypted peer-to-peer coordination...
...
- With sound software design/architecture (Supportability), components should be reusable.
