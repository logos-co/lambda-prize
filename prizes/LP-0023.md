...
- [ ] README documents setup, the deployed program ID, and step-by-step usage via CLI and Logos UI Module.
...
- Public repository with the registry program, SDK, CLI, and Logos UI Module under MIT or Apache-2.0.
