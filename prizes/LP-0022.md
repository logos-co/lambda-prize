...
dependencies:
  ...
  - id: LP-0023
    reason: approval flow must show program source-verification status; LP-0023's registry is the recommended (not required) provider
---
...
- [LP-0023](LP-0023.md) — Program registry with verified builds for LEZ programs (bytecode-to-source). Source verification itself is required (see Usability above); using LP-0023's registry specifically is recommended but not required — any equivalent registry satisfies the criterion.
