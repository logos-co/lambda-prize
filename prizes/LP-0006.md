...
- [ ] An **IDL** is provided for the LEZ escrow program(s), preferably using the [SPEL framework](https://github.com/logos-co/spel).
...
- **Mainnet deployment**: A subsequent prize may fund mainnet deployment of the atomic swap application, with adoption-related success criteria (e.g., volume, number of unique users, liquidity thresholds).
