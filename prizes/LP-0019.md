...
dependencies:
  - id: RFP-003
    reason: improves taker reliability in the RFP-003 LEZ atomic-swap protocol and builds on its SDK as the underlying primitive
---
...
[LP-0018 §Overview](./LP-0018.md#overview)). The **maker**
...
- [LP-0018: Spam Protection for Atomic-Swap Makers](./LP-0018.md)
