...
**`Status: Draft - pending LEZ blocktime feature`**
**`Logos Circle: N/A`**
## Overview
...
Logos' shielded account model makes hidden balances a native primitive. This prize demonstrates the power of that model by funding a sealed-bid auction on LEZ — one where participants commit bids without revealing their amounts, no bidder can see competitors' maximum offers, and the winner is determined and assets transferred entirely on-chain without a trusted auctioneer.
